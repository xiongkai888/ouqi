...
import com.lanmei.ouqi.ui.mine.fragment.RedPacketListFragment;

/**
 * 我的红包
 */
public class MineRedPacketAdapter extends FragmentPagerAdapter {

    private Context context;

    public MineRedPacketAdapter(FragmentManager fm, Context context) {
        super(fm);
